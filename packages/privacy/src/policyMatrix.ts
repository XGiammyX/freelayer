...
export const POLICY_MATRIX_SPECS: readonly PolicyMatrixSpec[] = [
  ...
  // ---- TECH-17: operation-log read/clear + deterministic replay + future
  //      snapshot gate. All local; nothing persists or egresses. ----
  {
    id: "room.operation_log_read",
    domain: "room",
    operation: "room.operation_log.read",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: EMERGENCY_DENY,
    reasonCode: "default_deny",
    reasonOverrides: { emergency: "emergency_mode" },
    rationale: "Reading the memory-only operation log is a local, policy-gated access.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    id: "room.operation_log_clear",
    domain: "room",
    ...
    reasonCode: "default_deny",
    rationale:
      "Clearing the memory log is allowed in every mode (wipe direction, incl. Emergency).",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    id: "room.replay_local",
    domain: "room",
    operation: "room.replay",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: EMERGENCY_DENY,
    reasonCode: "default_deny",
    reasonOverrides: { emergency: "emergency_mode" },
    rationale:
      "Deterministic replay is a pure, local, in-memory reconstruction of accepted events.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    id: "room.snapshot_future",
    domain: "room",
    operation: "room.project.snapshot",
    effect: "future_gate",
    reasonCode: "deferred_gate",
    rationale:
      "Snapshots/compaction are a future derived-data storage class: they can retain deleted content and depend on Gate F encryption + StoragePolicy/PBOM review.",
    testCoverage: "deferred",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/STORAGE_MODEL.md"],
  },
  // ---- TECH-18: RoomOS Object Model v1. Object mutation is a LOCAL, memory-
  //      only state transition; persistent plaintext content is denied; safe-
  //      direction ops (redact/tombstone) survive Emergency; voting/resolution/
  //      preview/remote refs stay gated. Per-kind behavior is derived by
  //      resolveRoomObjectMutationPolicy; these rows pin the class-level rule. ----
  {
    id: "room.object_create",
    domain: "room",
    ...
    reasonOverrides: { emergency: "emergency_mode" },
    rationale:
      "Creating a local object (message/note/task/decision/poll/file_ref) is a memory-only transition; content never persists; Emergency denies.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    id: "room.object_update",
    domain: "room",
    operation: "room.object.update",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: EMERGENCY_DENY,
    reasonCode: "default_deny",
    reasonOverrides: { emergency: "emergency_mode" },
    rationale:
      "Editing local object content/status (explicit commands only; no generic patch) is memory-only; Emergency denies ordinary edits.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    id: "room.object_redact",
    domain: "room",
    operation: "room.object.redact",
    sink: "local_memory",
    effect: "memory_only",
    reasonCode: "default_deny",
    rationale:
      "Redaction removes local object content (memory-only) and is allowed in every mode incl. Emergency (safe direction).",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/PRIVACY_MODEL.md"],
  },
  {
    id: "room.object_archive",
    domain: "room",
    operation: "room.object.archive",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: EMERGENCY_DENY,
    reasonCode: "default_deny",
    reasonOverrides: { emergency: "emergency_mode" },
    rationale: "Archiving makes a local object read-only (memory-only); Emergency denies.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    id: "room.object_tombstone",
    domain: "room",
    operation: "room.object.tombstone",
    sink: "local_memory",
    effect: "memory_only",
    reasonCode: "default_deny",
    rationale:
      "Tombstoning is terminal and content-clearing (memory-only), allowed in every mode incl. Emergency (wipe direction). Not forensic erasure.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/PRIVACY_MODEL.md"],
  },
  {
    id: "room.object_persist",
    domain: "room",
    operation: "room.object.persist",
    sink: "local_persistent_storage",
    dataClass: "message_content",
    effect: "deny",
    reasonCode: "persistent_storage_forbidden",
    rationale:
      "Persistent plaintext object content is denied until the encrypted backend exists (Gate F); Ghost/Bunker deny forever.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/STORAGE_MODEL.md"],
  },
  {
    id: "room.object_log_append",
    domain: "room",
    operation: "room.object_log.append",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: EMERGENCY_DENY,
    reasonCode: "default_deny",
    reasonOverrides: { emergency: "emergency_mode" },
    rationale:
      "The object mutation log is a memory-only placeholder; append requires its OWN storage decision, separate from the mutation.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/STORAGE_MODEL.md"],
  },
  {
    id: "room.object_poll_vote",
    domain: "room",
    operation: "room.object.poll_vote",
    effect: "future_gate",
    reasonCode: "deferred_gate",
    rationale:
      "Poll voting/tallies require verified identity (Gate G) and sync (Gate H); no vote capability exists in v1.",
    testCoverage: "deferred",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/IMPLEMENTATION_GATES.md"],
  },
  {
    id: "room.object_file_resolve",
    domain: "room",
    operation: "room.object.file_resolve",
    effect: "future_gate",
    reasonCode: "deferred_gate",
    rationale:
      "Resolving/reading a file reference (bytes) is future work; file refs hold no path/URL/bytes (Gate E capsule design).",
    testCoverage: "deferred",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/IMPLEMENTATION_GATES.md"],
  },
  {
    id: "room.object_file_preview",
    domain: "room",
    operation: "room.object.file_preview",
    effect: "deny",
    reasonCode: "link_preview_forbidden",
    rationale:
      "File/thumbnail previews are forbidden — no rendering, no fetch, no MIME-driven preview.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/NETWORK_MODEL.md"],
  },
  {
    id: "room.object_file_remote",
    domain: "room",
    operation: "room.object.file_remote",
    effect: "deny",
    reasonCode: "network_forbidden",
    rationale:
      "Remote file references / fetch / upload / download are forbidden (no network in RoomOS).",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/NETWORK_MODEL.md"],
  },
  {
    id: "room.object_ai_memory",
    domain: "room",
    operation: "room.object.ai_memory",
    effect: "future_gate",
    reasonCode: "deferred_gate",
    rationale:
      "AI memory-ref objects carry no AI content/embeddings/model calls; future-gated (Gate I).",
    testCoverage: "deferred",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/IMPLEMENTATION_GATES.md"],
  },
  {
    id: "room.object_endpoint_hook",
    domain: "room",
    operation: "room.object.endpoint_hook",
    effect: "future_gate",
    reasonCode: "deferred_gate",
    rationale:
      "Endpoint-hook objects are externalized placeholders — no capture, no monitoring, no active protection; integration requires Gate R.",
    testCoverage: "deferred",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/IMPLEMENTATION_GATES.md"],
  },
  // ---- TECH-19: RoomOS privacy-safe local query model. Queries are side-
  //      effect-free, local, memory-only reads; each requires its own exact-
  //      scope decision. History/cache/index are forbidden; strict modes
  //      redact; Bunker/Emergency deny content/search/counts. ----
  {
    id: "room.query_summary",
    domain: "room",
    operation: "room.query.summary",
    sink: "local_memory",
    effect: "memory_only",
    reasonCode: "default_deny",
    rationale:
      "Room summary query is a side-effect-free local read; strict modes return a redacted summary. Allowed (minimally) even in Emergency.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    ...
    reasonOverrides: { emergency: "emergency_mode" },
    rationale:
      "Object/task/decision/poll/file-ref list queries are local memory-only reads (metadata-minimized summaries); Emergency denies.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    id: "room.query_detail",
    domain: "room",
    operation: "room.query.detail",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: EMERGENCY_DENY,
    reasonCode: "default_deny",
    reasonOverrides: { emergency: "emergency_mode" },
    rationale:
      "Object detail query returns in-memory content only where policy allows (never in Bunker/Emergency); redacted/tombstoned content never reappears.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/PRIVACY_MODEL.md"],
  },
  {
    id: "room.query_search",
    domain: "room",
    operation: "room.query.search",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: OFFLINE_EMERGENCY_DENY,
    reasonCode: "default_deny",
    reasonOverrides: { offline_capsule: "offline_capsule_mode", emergency: "emergency_mode" },
    rationale:
      "Exact case-sensitive in-memory substring search only (no index/history/cache/snippet); Bunker/Emergency deny; the term is never logged.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    ...
    reasonOverrides: { emergency: "emergency_mode" },
    rationale:
      "Object counts are metadata behind their OWN scope; Standard/Offline may allow exact local counts, Private/Ghost/Bunker deny by default.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/METADATA_MODEL.md"],
  },
  {
    id: "room.query_history",
    domain: "room",
    operation: "room.query.history",
    sink: "local_persistent_storage",
    dataClass: "materialized_room_state",
    effect: "deny",
    reasonCode: "persistent_storage_forbidden",
    rationale:
      "Query history is forbidden in every mode — no query term/kind/result is ever retained.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/METADATA_MODEL.md"],
  },
  {
    id: "room.query_result_cache",
    domain: "room",
    operation: "room.query.result_cache",
    sink: "local_persistent_storage",
    dataClass: "materialized_room_state",
    effect: "deny",
    reasonCode: "persistent_storage_forbidden",
    rationale: "Query-result caching is forbidden in every mode.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/STORAGE_MODEL.md"],
  },
  {
    id: "room.query_search_index",
    domain: "room",
    operation: "room.query.search_index",
    sink: "local_persistent_storage",
    dataClass: "materialized_room_state",
    effect: "deny",
    reasonCode: "persistent_storage_forbidden",
    rationale:
      "A persistent search/token index would duplicate content; forbidden in v1 (future design gate required).",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/STORAGE_MODEL.md"],
  },
  {
    id: "room.query_semantic_future",
    domain: "room",
    operation: "room.query.semantic",
    effect: "future_gate",
    reasonCode: "deferred_gate",
    rationale: "Semantic/embedding/NL search requires local AI — future-gated (Gate I).",
    testCoverage: "deferred",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/IMPLEMENTATION_GATES.md"],
  },
  {
    id: "room.query_remote_future",
    domain: "room",
    operation: "room.query.remote",
    effect: "future_gate",
    reasonCode: "deferred_gate",
    rationale: "Remote/synchronized queries require the sync model — future-gated (Gate H).",
    testCoverage: "deferred",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/IMPLEMENTATION_GATES.md"],
  },
  {
    id: "room.query_bunker_content_future",
    domain: "room",
    operation: "room.query.bunker_content_view",
    effect: "future_gate",
    reasonCode: "deferred_gate",
    rationale:
      "Content-bearing query views in Bunker require a future protected-presentation integration gate; denied in TECH-19.",
    testCoverage: "deferred",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/IMPLEMENTATION_GATES.md"],
  },
  // ---- TECH-20: RoomOS membership + non-authoritative capability scaffolding.
  //      Local unverified memberships; memory/null only; expansion denied in
  //      Bunker/Emergency; restrictive suspend/remove survive; descriptors are
  //      never persisted/serialized/delegated; identity/invite/distributed
  //      revocation are future gates. ----
  {
    id: "room.membership_bootstrap",
    domain: "room",
    operation: "room.membership.bootstrap",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: EMERGENCY_DENY,
    reasonCode: "default_deny",
    reasonOverrides: { emergency: "emergency_mode" },
    rationale:
      "Bootstrapping the first local owner-placeholder is a memory-only transition during room creation; Emergency denies.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    id: "room.membership_add",
    domain: "room",
    operation: "room.membership.add",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: { bunker: "deny", emergency: "deny" },
    reasonCode: "default_deny",
    reasonOverrides: { bunker: "strict_mode", emergency: "emergency_mode" },
    rationale:
      "Adding a local placeholder member is memory-only; Bunker/Emergency deny membership expansion.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    id: "room.membership_change_role",
    domain: "room",
    operation: "room.membership.change_role",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: { bunker: "deny", emergency: "deny" },
    reasonCode: "default_deny",
    reasonOverrides: { bunker: "strict_mode", emergency: "emergency_mode" },
    rationale:
      "Role changes are memory-only and preserve last-owner continuity; Bunker/Emergency deny.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    id: "room.membership_suspend",
    domain: "room",
    operation: "room.membership.suspend",
    sink: "local_memory",
    effect: "memory_only",
    reasonCode: "default_deny",
    rationale:
      "Suspension is a restrictive/safety-direction transition (memory-only); may be permitted even in Bunker/Emergency when policy allows. Last active owner cannot be suspended.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    id: "room.membership_reactivate",
    domain: "room",
    operation: "room.membership.reactivate",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: { bunker: "deny", emergency: "deny" },
    reasonCode: "default_deny",
    reasonOverrides: { bunker: "strict_mode", emergency: "emergency_mode" },
    rationale: "Reactivation is membership expansion (memory-only); Bunker/Emergency deny.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    id: "room.membership_remove",
    domain: "room",
    ...
    reasonCode: "default_deny",
    rationale:
      "Removal tombstones a membership (terminal, memory-only, wipe direction); may be permitted in Bunker/Emergency. Last active owner cannot be removed.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    id: "room.membership_log_append",
    domain: "room",
    operation: "room.membership_log.append",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: EMERGENCY_DENY,
    reasonCode: "default_deny",
    reasonOverrides: { emergency: "emergency_mode" },
    rationale:
      "The membership event log is a memory-only placeholder; append needs its OWN storage decision, separate from the mutation.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/STORAGE_MODEL.md"],
  },
  {
    id: "room.membership_list_redacted",
    domain: "room",
    operation: "room.membership.query.list",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: { bunker: "deny", emergency: "deny" },
    reasonCode: "default_deny",
    reasonOverrides: { bunker: "strict_mode", emergency: "emergency_mode" },
    rationale:
      "Redacted membership listing is a local read; Bunker/Emergency deny ordinary listing. Never exposes identity/presence/capability descriptors.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/METADATA_MODEL.md"],
  },
  {
    id: "room.membership_detail_redacted",
    domain: "room",
    operation: "room.membership.query.detail",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: { bunker: "deny", emergency: "deny" },
    reasonCode: "default_deny",
    reasonOverrides: { bunker: "strict_mode", emergency: "emergency_mode" },
    rationale: "Redacted membership detail is a local read; Bunker/Emergency deny.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    id: "room.membership_count",
    domain: "room",
    operation: "room.membership.query.count",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: { private: "deny", ghost: "deny", bunker: "deny", emergency: "deny" },
    reasonCode: "default_deny",
    reasonOverrides: {
      private: "metadata_forbidden",
      ghost: "strict_mode",
      bunker: "strict_mode",
      emergency: "emergency_mode",
    },
    rationale:
      "Membership count is activity metadata behind its OWN scope; Standard/Offline/Sovereign allow, Private/Ghost/Bunker/Emergency deny.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/METADATA_MODEL.md"],
  },
  {
    id: "room.capability_resolve",
    domain: "room",
    operation: "room.capability.resolve",
    sink: "local_memory",
    effect: "memory_only",
    reasonCode: "default_deny",
    rationale:
      "Capability resolution is a pure, local, side-effect-free policy computation producing a non-authoritative descriptor (never a token).",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    id: "room.capability_persist",
    domain: "room",
    operation: "room.capability.persist",
    sink: "local_persistent_storage",
    dataClass: "materialized_room_state",
    effect: "deny",
    reasonCode: "persistent_storage_forbidden",
    rationale: "Capability descriptors are never persisted or cached (they are not credentials).",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/STORAGE_MODEL.md"],
  },
  {
    id: "room.capability_serialize",
    domain: "room",
    operation: "room.capability.serialize",
    effect: "deny",
    reasonCode: "default_deny",
    rationale:
      "Capability descriptor serialization is forbidden (no bearer tokens / capability URLs).",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    id: "room.capability_delegate_future",
    domain: "room",
    operation: "room.capability.delegate",
    effect: "not_implemented",
    reasonCode: "deferred_gate",
    rationale: "Capability delegation is not implemented (a real capability runtime is Gate B).",
    testCoverage: "deferred",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/IMPLEMENTATION_GATES.md"],
  },
  {
    id: "room.membership_invite_future",
    domain: "room",
    operation: "room.membership.invite",
    effect: "future_gate",
    reasonCode: "deferred_gate",
    rationale: "Invites require identity + capsule wire format — future-gated (Gate G/E).",
    testCoverage: "deferred",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/IMPLEMENTATION_GATES.md"],
  },
  {
    id: "room.membership_verify_future",
    domain: "room",
    operation: "room.membership.identity_verify",
    effect: "future_gate",
    reasonCode: "deferred_gate",
    rationale: "Identity verification of members is Gate G; every member stays unverified in v1.",
    testCoverage: "deferred",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/IMPLEMENTATION_GATES.md"],
  },
  {
    id: "room.membership_distributed_revocation_future",
    domain: "room",
    operation: "room.membership.distributed_revocation",
    effect: "future_gate",
    reasonCode: "deferred_gate",
    rationale:
      "Distributed revocation requires the sync model — future-gated (Gate H). Local removal is not distributed revocation.",
    testCoverage: "deferred",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/IMPLEMENTATION_GATES.md"],
  },
  {
    id: "room.membership_endpoint_risk",
    domain: "room",
    operation: "room.membership.endpoint_risk_integration",
    effect: "future_gate",
    reasonCode: "deferred_gate",
    rationale:
      "Endpoint-risk is a local, untrusted policy input that can only TIGHTEN — never identity assurance or authority. Integration is externalized (Gate R).",
    testCoverage: "deferred",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/IMPLEMENTATION_GATES.md"],
  },
  ...
  //      provider is integrated (Null provider only); posture above `unverified`
  //      cannot be established; `at_risk` can only restrict. Raw evidence,
  //      device identifiers, assessment history, and app inventory are FORBIDDEN.
  //      ScreenShield / Bunker Session / trusted provider stay future-gated. ----
  {
    id: "room.secure_device.provider_status_read",
    domain: "room",
    operation: "room.secure_device.provider_status_read",
    sink: "local_memory",
    effect: "memory_only",
    reasonCode: "default_deny",
    rationale:
      "Reading Secure Device provider status is a local, static, content-free lookup; in core it always reports not_integrated and trustedForPostureElevation=false.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/ENDPOINT_DEFENSE_MODEL.md"],
  },
  {
    id: "room.secure_device.provider_capabilities_read",
    domain: "room",
    operation: "room.secure_device.provider_capabilities_read",
    sink: "local_memory",
    effect: "memory_only",
    reasonCode: "default_deny",
    rationale:
      "Reading provider capabilities is a static content-free lookup; every capability is unavailable/future-gated and raw-evidence/device-management/telemetry are forbidden.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/ENDPOINT_DEFENSE_MODEL.md"],
  },
  {
    id: "room.device_posture.assessment_read",
    domain: "room",
    operation: "room.device_posture.assessment_read",
    sink: "local_memory",
    effect: "memory_only",
    reasonCode: "default_deny",
    rationale:
      "Reading the normalized posture assessment is transient/memory-only; effective posture is unverified (or at_risk); no raw evidence or device identifiers are included.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/ENDPOINT_DEFENSE_MODEL.md"],
  },
  {
    id: "room.device_posture.at_risk_tighten",
    domain: "room",
    operation: "room.device_posture.at_risk_tighten",
    sink: "local_memory",
    effect: "memory_only",
    reasonCode: "accepted_limitation",
    rationale:
      "An untrusted signal may tighten to at_risk (a RESTRICTION only); at_risk overrides every higher claim and never grants or restores access.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/ENDPOINT_DEFENSE_MODEL.md"],
  },
  {
    id: "room.raw_device_evidence.input",
    domain: "room",
    operation: "room.raw_device_evidence.input",
    effect: "deny",
    reasonCode: "default_deny",
    rationale:
      "Raw attestation Evidence is NEVER accepted as input to core; as the RATS Relying Party, FreeLayer consumes only a normalized result (evidence-bearing objects are rejected).",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/ENDPOINT_DEFENSE_MODEL.md"],
  },
  {
    id: "room.raw_device_evidence.persist",
    domain: "room",
    operation: "room.raw_device_evidence.persist",
    sink: "local_persistent_storage",
    dataClass: "device_risk_state",
    effect: "deny",
    reasonCode: "persistent_storage_forbidden",
    rationale:
      "Raw device evidence / measurement logs are never stored; core neither receives nor persists them.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/STORAGE_MODEL.md"],
  },
  {
    id: "room.device_identifier.collect",
    domain: "room",
    operation: "room.device_identifier.collect",
    effect: "deny",
    reasonCode: "default_deny",
    rationale:
      "Device identifiers / serials / OS build fingerprints are never collected; the assessment carries deviceIdentifiersIncluded=false.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/PRIVACY_MODEL.md"],
  },
  {
    id: "room.device_assessment_history.persist",
    domain: "room",
    operation: "room.device_assessment_history.persist",
    sink: "local_persistent_storage",
    dataClass: "device_risk_state",
    effect: "deny",
    reasonCode: "persistent_storage_forbidden",
    rationale:
      "Persistent assessment history is forbidden; each assessment is transient and current-process only (no tracking record).",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/STORAGE_MODEL.md"],
  },
  {
    id: "room.device_inventory.collect",
    domain: "room",
    operation: "room.device_inventory.collect",
    effect: "deny",
    reasonCode: "default_deny",
    rationale:
      "Installed-app / package inventory is never collected in core; app scanning is external Secure Device work and is not performed here.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/ENDPOINT_DEFENSE_MODEL.md"],
  },
  {
    id: "room.secure_device.summary_redacted",
    domain: "room",
    operation: "room.secure_device.summary_redacted",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: EMERGENCY_DENY,
    reasonCode: "default_deny",
    reasonOverrides: { emergency: "emergency_mode" },
    rationale:
      "A redacted room summary is metadata-only and separately gated from content; it is refused in Emergency and in locked lifecycles.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/METADATA_MODEL.md"],
  },
  {
    id: "room.secure_device.summary_full",
    domain: "room",
    operation: "room.secure_device.summary_full",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: EMERGENCY_DENY,
    reasonCode: "default_deny",
    reasonOverrides: { emergency: "emergency_mode" },
    rationale:
      "A full room summary reveals content and is admission-gated by posture + protected presentation; content denies when the provider is absent or the room requires basic+.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    id: "room.secure_device.content_read",
    domain: "room",
    ...
    reasonOverrides: { emergency: "emergency_mode" },
    rationale:
      "Content read is admission-gated: at_risk denies; basic+ requirement denies (no provider); ScreenShield/Bunker requirement denies; unverified-only rooms follow other policy.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    id: "room.secure_device.content_mutate",
    domain: "room",
    operation: "room.secure_device.content_mutate",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: EMERGENCY_DENY,
    reasonCode: "default_deny",
    reasonOverrides: { emergency: "emergency_mode" },
    rationale:
      "Content mutation is admission-gated identically to content read; at_risk and unmet posture/protection deny.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    id: "room.secure_device.content_search",
    domain: "room",
    operation: "room.secure_device.content_search",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: EMERGENCY_DENY,
    reasonCode: "default_deny",
    reasonOverrides: { emergency: "emergency_mode" },
    rationale:
      "Local content search is admission-gated as a content action; at_risk and unmet posture/protection deny.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    id: "room.secure_device.content_export",
    domain: "room",
    operation: "room.secure_device.content_export",
    effect: "not_implemented",
    reasonCode: "accepted_limitation",
    rationale:
      "Content export is not implemented; it is a future gate and is denied after admission gating (no export surface exists in core).",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    id: "room.secure_device.content_copy",
    domain: "room",
    operation: "room.secure_device.content_copy",
    effect: "not_implemented",
    reasonCode: "accepted_limitation",
    rationale:
      "Content copy/clipboard extraction is not implemented in core (clipboard handling is external Secure Device work); denied.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/ENDPOINT_DEFENSE_MODEL.md"],
  },
  {
    id: "room.secure_device.file_open",
    domain: "room",
    operation: "room.secure_device.file_open",
    effect: "not_implemented",
    reasonCode: "accepted_limitation",
    rationale:
      "File open is not implemented in core (file_ref objects are references only); denied as a future gate.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    id: "room.secure_device.local_ai_use",
    domain: "room",
    operation: "room.secure_device.local_ai_use",
    effect: "not_implemented",
    reasonCode: "ai_forbidden",
    rationale:
      "Local AI over room content is not implemented (Gate I); denied as a future gate, and additionally admission-gated.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/IMPLEMENTATION_GATES.md"],
  },
  {
    id: "room.secure_device.protected_content_intent",
    domain: "room",
    operation: "room.secure_device.protected_content_intent",
    sink: "local_memory",
    effect: "memory_only",
    reasonCode: "default_deny",
    rationale:
      "A protected-content intent is a data-only description; core never renders content, blocks screenshots, or claims capture protection; future-required protection denies content.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/ENDPOINT_DEFENSE_MODEL.md"],
  },
  {
    id: "room.secure_device.session_create",
    domain: "room",
    operation: "room.secure_device.session_create",
    sink: "local_memory",
    effect: "memory_only",
    reasonCode: "default_deny",
    rationale:
      "A sensitive-room session is transient/current-process only; a denied admission cannot create an admitted session; it is never persisted and never survives a restart.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md", "docs/STORAGE_MODEL.md"],
  },
  {
    id: "room.secure_device.session_revalidate",
    domain: "room",
    operation: "room.secure_device.session_revalidate",
    sink: "local_memory",
    effect: "memory_only",
    reasonCode: "default_deny",
    rationale:
      "Per-operation session revalidation invalidates on any posture/provider/policy/membership/mode/lifecycle/action change; recovery requires a fresh assessment + admission + authorization.",
    testCoverage: "covered",
    docsRefs: ["docs/SOVEREIGN_ROOMS.md"],
  },
  {
    id: "room.secure_device.provider_elevation_future",
    domain: "room",
    operation: "room.secure_device.provider_elevation",
    effect: "future_gate",
    reasonCode: "deferred_gate",
    rationale:
      "A trusted provider that could elevate posture (basic/hardened/high_assurance/managed_bunker) requires the SEPARATE Secure Device project + the Secure Device Integration Gate + ADR.",
    testCoverage: "deferred",
    docsRefs: ["docs/IMPLEMENTATION_GATES.md", "docs/ENDPOINT_DEFENSE_MODEL.md"],
  },
  {
    id: "room.secure_device.screen_shield_require_future",
    domain: "room",
    operation: "room.secure_device.screen_shield_require",
    effect: "future_gate",
    reasonCode: "deferred_gate",
    rationale:
      "Native ScreenShield is external; a ScreenShield requirement DENIES content now with no silent downgrade and no active-protection claim.",
    testCoverage: "deferred",
    docsRefs: ["docs/ENDPOINT_DEFENSE_MODEL.md", "docs/IMPLEMENTATION_GATES.md"],
  },
  {
    id: "room.secure_device.bunker_session_require_future",
    domain: "room",
    operation: "room.secure_device.bunker_session_require",
    effect: "future_gate",
    reasonCode: "deferred_gate",
    rationale:
      "Managed Bunker Session Mode is implemented in the SEPARATE Secure Device project; any Bunker requirement denies content now.",
    testCoverage: "deferred",
    docsRefs: ["docs/ENDPOINT_DEFENSE_MODEL.md", "docs/IMPLEMENTATION_GATES.md"],
  },
  {
  ...
  // ---- TECH-ID-04: Ephemeral Identity. Independent current-process root context;
  //      current-process memory or null (never persistent). Expansive creates deny
  //      in Bunker/Emergency; restrictive lifecycle (shorten/expire/mark/destroy/
  //      block) may run everywhere. Promotion/recovery/export/synchronization/
  //      persistence are DENIED. No forensic erasure / remote deletion / anonymity. ----
  {
    id: "identity.ephemeral_create",
    domain: "identity",
    operation: "identity.ephemeral.create",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: IDENTITY_EXPANSIVE_DENY,
    reasonCode: "default_deny",
    reasonOverrides: { emergency: "emergency_mode" },
    rationale:
      "Creating an INDEPENDENT current-process ephemeral root is memory-only, bounded-lifetime, non-recoverable; denied in Bunker/Emergency (expansive). No promotion/export/sync/persistence.",
    testCoverage: "covered",
    docsRefs: ["docs/IDENTITY_ARCHITECTURE.md", "docs/IDENTITY_FIREWALL.md"],
  },
  {
    id: "identity.ephemeral_activate",
    domain: "identity",
    operation: "identity.ephemeral.activate",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: IDENTITY_EXPANSIVE_DENY,
    reasonCode: "default_deny",
    reasonOverrides: { emergency: "emergency_mode" },
    rationale:
      "Activating a draft ephemeral root is memory-only and epoch/deadline-checked; denied in Bunker/Emergency (expansive).",
    testCoverage: "covered",
    docsRefs: ["docs/IDENTITY_ARCHITECTURE.md"],
  },
  {
    id: "identity.ephemeral_restrictive",
    domain: "identity",
    operation: "identity.ephemeral.restrictive",
    sink: "local_memory",
    effect: "memory_only",
    reasonCode: "default_deny",
    rationale:
      "Restrictive ephemeral lifecycle ops (shorten-lifetime/mark-compromised/expire/destroy) are memory-only, revision-guarded; available in strict modes incl. Emergency. Lifetime can only be shortened.",
    testCoverage: "covered",
    docsRefs: ["docs/IDENTITY_ARCHITECTURE.md"],
  },
  {
    id: "identity.ephemeral_persona_create",
    domain: "identity",
    operation: "identity.ephemeral.persona.create",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: IDENTITY_EXPANSIVE_DENY,
    reasonCode: "default_deny",
    reasonOverrides: { emergency: "emergency_mode" },
    rationale:
      "An ephemeral persona belongs only to one ephemeral root; no long-lived inheritance. Denied in Bunker/Emergency (expansive).",
    testCoverage: "covered",
    docsRefs: ["docs/IDENTITY_ARCHITECTURE.md"],
  },
  {
    id: "identity.ephemeral_relationship_create",
    domain: "identity",
    operation: "identity.ephemeral.relationship.create",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: IDENTITY_EXPANSIVE_DENY,
    reasonCode: "default_deny",
    reasonOverrides: { emergency: "emergency_mode" },
    rationale:
      "An ephemeral relationship placeholder inherits no long-lived contact/trust/verification. Denied in Bunker/Emergency (expansive).",
    testCoverage: "covered",
    docsRefs: ["docs/IDENTITY_ARCHITECTURE.md"],
  },
  {
    id: "identity.ephemeral_relationship_block",
    domain: "identity",
    operation: "identity.ephemeral.relationship.block",
    sink: "local_memory",
    effect: "memory_only",
    reasonCode: "default_deny",
    rationale:
      "Blocking an ephemeral relationship is local, restrictive, memory-only; it claims no remote block or deletion.",
    testCoverage: "covered",
    docsRefs: ["docs/IDENTITY_ARCHITECTURE.md"],
  },
  {
    id: "identity.ephemeral_room_binding_create",
    domain: "identity",
    operation: "identity.ephemeral.room_binding.create",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: IDENTITY_EXPANSIVE_DENY,
    reasonCode: "default_deny",
    reasonOverrides: { emergency: "emergency_mode" },
    rationale:
      "An ephemeral room binding is room-scoped, exposes no root material; RoomMembershipId is not identity proof. Denied in Bunker/Emergency (expansive).",
    testCoverage: "covered",
    docsRefs: ["docs/IDENTITY_ARCHITECTURE.md", "docs/SOVEREIGN_ROOMS.md"],
  },
  {
    id: "identity.ephemeral_summary_read",
    domain: "identity",
    operation: "identity.ephemeral.summary.read",
    sink: "local_memory",
    effect: "memory_only",
    effectOverrides: EMERGENCY_DENY,
    reasonCode: "default_deny",
    reasonOverrides: { emergency: "emergency_mode" },
    rationale:
      "A redacted ephemeral summary read needs its OWN decision; strict modes omit ids/deadline/counts; `anonymous` is structurally false.",
    testCoverage: "covered",
    docsRefs: ["docs/IDENTITY_ARCHITECTURE.md"],
  },
  {
    id: "identity.ephemeral_promotion",
    domain: "identity",
    operation: "identity.ephemeral.promotion",
    effect: "deny",
    reasonCode: "default_deny",
    rationale:
      "An ephemeral identity can NEVER be promoted to a long-lived identity or attached to a long-lived root; there is no conversion path.",
    testCoverage: "covered",
    docsRefs: [
      "docs/IDENTITY_ARCHITECTURE.md",
      "docs/adr/ADR-0013-identity-firewall-architecture.md",
  ...
  {
    id: "identity.ephemeral_recovery",
    domain: "identity",
    operation: "identity.ephemeral.recovery",
    effect: "deny",
    reasonCode: "default_deny",
    rationale: "Ephemeral identities have NO recovery; recovery can never be enabled.",
    testCoverage: "covered",
    docsRefs: ["docs/IDENTITY_ARCHITECTURE.md"],
  },
  {
    id: "identity.ephemeral_export",
    domain: "identity",
    operation: "identity.ephemeral.export",
    effect: "deny",
    reasonCode: "default_deny",
    rationale:
      "Ephemeral identity export/import is denied (no serialized identity format — Gate E).",
    testCoverage: "covered",
    docsRefs: ["docs/IDENTITY_ARCHITECTURE.md"],
  },
  {
    id: "identity.ephemeral_synchronize",
    domain: "identity",
    operation: "identity.ephemeral.synchronize",
    effect: "deny",
    reasonCode: "default_deny",
    rationale:
      "Ephemeral identity synchronization/transfer across devices is denied; it is current-process only (Gate H).",
    testCoverage: "covered",
    docsRefs: ["docs/IDENTITY_ARCHITECTURE.md"],
  },
  {
    id: "identity.ephemeral_persistent_storage",
    domain: "identity",
    operation: "identity.ephemeral.persistent_storage",
    sink: "local_persistent_storage",
    dataClass: "ephemeral_identity_root",
    effect: "deny",
    reasonCode: "persistent_storage_forbidden",
    rationale:
